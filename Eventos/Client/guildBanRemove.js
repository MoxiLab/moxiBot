...
module.exports = async (guild, user) => {
    if (isFlagEnabled('guildBanRemove')) console.log('[GUILDBANREMOVE_DEBUG] Ejecutado: guildBanRemove');
    try {
        ...
        console.error('[LOG EVENT ERROR] Error general en guildBanRemove:', e);
    }
};
